...
def generate_launch_description():
    ...
    left_pose_tracking_yaml = load_yaml("moveit_servo", "config/pose_tracking_settings.yaml")
    ...
    rviz_node = Node(
        ...
        name='rviz2',
        output='log',
        remappings=[('rviz_visual_tools', 'right_arm/rviz_visual_tools'), ('display_planned_path', 'right_arm/display_planned_path'),
                    ('monitored_planning_scene', 'right_arm/monitored_planning_scene'), ('display_planned_path', 'right_arm/display_planned_path'),
                    ('initialpose', 'right_arm/initialpose'), ('goal_pose', 'right_arm/goal_pose'), ('clicked_point', 'right_arm/clicked_point')],
    ...
    right_pose_tracking = TimerAction(
        ...
        actions=[Node(
            ...
            executable="right_pos_tracking",
            remappings=[('target_pose', 'right_arm/target_pose')],
            output="screen",
            parameters=[servo_params, robot_description, robot_description_semantic, left_pose_tracking_params,
                        joint_limits_yaml],
        )],
    )
    ...
    ros2_control_node = Node(
        ...
        remappings=[('joint_states', 'right_franka/joint_states')],
        output={
            'stdout': 'screen',
            'stderr': 'screen',
        },
